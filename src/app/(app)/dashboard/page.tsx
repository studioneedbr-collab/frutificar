...
const lives = [
  { title: 'Manejo de pragas na entressafra', agro: 'Agr. Helena Prado', when: 'Qua, 26 jun · 19h', tag: 'AO VIVO' },
        ...
        <div className="space-y-6">
          ...
          <section className="dash-anim rounded-2xl p-6 bg-white" style={{ border: '1px solid oklch(0.91 0.01 144)', animationDelay: '0.3s' }}>
            ...
            <div className="rounded-xl p-4 mb-3" style={{ background: 'linear-gradient(150deg, oklch(0.48 0.13 144 / 0.06), oklch(0.62 0.12 55 / 0.05))', border: '1px solid oklch(0.91 0.01 144)' }}>
              <h3 className="font-bold text-sm" style={{ color: 'var(--color-frutificar-deep)' }}>Fazenda Santa Clara</h3>
              <p className="text-xs mt-0.5" style={{ color: 'oklch(0.55 0.04 144)' }}>Patrocínio/MG · 84 ha · Café arábica</p>
