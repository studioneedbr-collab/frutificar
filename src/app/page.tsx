...
const plans = [
  {
    ...
    items: ['Curso completo com 8 módulos', 'Chat inteligente para dúvidas', 'Diagnóstico rápido por imagem', 'Acesso pelo App e Web'],
  ...
  },
  {
    ...
    price: 'R$ 97',
    period: '/mês',
    desc: 'Para quem quer gestão, minicursos e suporte técnico.',
    items: ['Tudo do Essencial', 'Minicursos especializados', 'Suporte técnico agendado', 'Gestão da propriedade rural', 'Podcasts técnicos'],
  ...
  },
  {
    ...
    price: 'R$ 197',
    period: '/mês',
    desc: 'Formação completa, com prática presencial e tutoria.',
    items: ['Tudo do Premium', 'Acesso a todos os cursos', 'Dia de campo presencial', 'Estágio supervisionado', 'Tutoria especializada'],
    cta: 'Assinar o Gold',
    highlight: false,
  },
]
      ...
      <div className="py-3 overflow-hidden" style={{ background: 'var(--color-frutificar-deep)' }}>
        <div className="ticker-track">
          {[
            ...
            '✔ Conteúdo validado por técnicos',
